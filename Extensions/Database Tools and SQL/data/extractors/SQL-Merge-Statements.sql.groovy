 ...
 *
 *
 * columns[0] is assumed to be the pk field. I'm still sifting through the ij source code to see if
 * I can get access to any sort of "is pk" on the columns so that this can function more accurately.
 */
